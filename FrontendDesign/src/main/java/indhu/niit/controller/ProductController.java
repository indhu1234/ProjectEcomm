...
public class ProductController 
{
  ...
  public String showProduct(Model m)
  {
	...
	public String insertProduct(@ModelAttribute("product")Product product,@RequestParam("pimage")MultipartFile filedet,Model m)
	{
		...
		String imagePath="C:\\Users\\MR USER\\git\\ProjectEcomm\\FrontendDesign\\src\\main\\webapp\\resources\\images\\";
	...
	public String updateProd(@ModelAttribute Product prod,HttpServletRequest request,Model model)
	{
	   System.out.println("First");
		   model.addAttribute("categoryList",categoryDAO.listCategories());
			   		
		   System.out.println("Add image");
		MultipartFile img=prod.getPimage();
		System.out.println("Path : "+request.getServletContext().getRealPath("/"));
		//Defining a path
		Path path=Paths.get(request.getServletContext().getRealPath("/")+"/resources/images/"+prod.getProdid()+".jpg");
